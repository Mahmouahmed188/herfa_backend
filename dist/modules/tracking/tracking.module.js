...
exports.TrackingModule = TrackingModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [tracking_gateway_1.TrackingGateway, notifications_gateway_1.NotificationsGateway],
        exports: [tracking_gateway_1.TrackingGateway, notifications_gateway_1.NotificationsGateway],
    })
], TrackingModule);
