...
describe('NotificationsController', () => {
  ...
  const mockNotificationsService = {
    ...
    markSingleAsRead: jest.fn().mockResolvedValue({ message: 'Notification marked as read' }),
    markAllAsRead: jest.fn().mockResolvedValue({ message: 'All notifications marked as read' }),
    markAsRead: jest.fn().mockResolvedValue({ message: 'Notifications marked as read' }),
  ...
  describe('getNotifications', () => {
    it('should return paginated notifications', async () => {
      ...
      expect(mockNotificationsService.findByUser).toHaveBeenCalledWith('user-uuid', {
        page: 1,
        limit: 20,
      });
  ...
  describe('getUnreadCount', () => {
    it('should return unread count', async () => {
      ...
      expect(mockNotificationsService.getUnreadCount).toHaveBeenCalledWith('user-uuid');
  ...
  describe('markAllAsRead', () => {
    it('should mark all notifications as read', async () => {
      ...
      expect(mockNotificationsService.markAllAsRead).toHaveBeenCalledWith('user-uuid');
  ...
  describe('markAsReadBulk', () => {
    it('should mark specific notifications as read', async () => {
      ...
      expect(mockNotificationsService.markAsRead).toHaveBeenCalledWith('user-uuid', [
        'notif-1',
        'notif-2',
      ]);
  ...
  describe('deleteNotification', () => {
    it('should delete a notification', async () => {
      const result = await controller.deleteNotification('notif-uuid', mockUser);

      expect(mockNotificationsService.delete).toHaveBeenCalledWith('notif-uuid', 'user-uuid');
